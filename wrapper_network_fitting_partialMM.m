function [best_fitted_parameters,best_fval,ODEstruct,cov] = wrapper_network_fitting_partialMM(topology_short_name,kineticsMap,kineticsMap_indicator,experimental_data,base_parameters)
    ...
    while min_fval > 1e04 && num_attempts < 5 % Added to ensure bad initial parameter values do not cause any failed parmaeter estimation attempt
        [fitted_parameters,min_fval,ODEstruct,fitted_paramsVecAll,fvalAll] = network_modelFitting_partialMM(topology_short_name,kineticsMap,kineticsMap_indicator,experimental_data,base_parameters,num_iter,quickSearch);
        ...
        %do a few more iterations 
            num_iter = 16;
            [fitted_parameters_2nd,min_fval_2nd,ODEstruct,~,~] = network_modelFitting_partialMM(topology_short_name,kineticsMap,kineticsMap_indicator,experimental_data,base_parameters,num_iter,quickSearch);
        end
