function wrapper_genNoisyData(hiResDataFileName,nT,cov,numSets)
    ...
    loResDataFileNameStem = sprintf('%s_nT-%03d_cov-%02d_rep-',hiResDataFileName(1:idxEnd(end)-1),nT,cov*100);
...
% %     fluxTimeVec = timeVec(1:end-1)+0.5*diff(timeVec(1:2));
    ...
    loResData.kineticsMap = hiResData.kineticsMap;
    loResData.perturbFlux = hiResData.perturbFlux;
    loResData.perturbSize = hiResData.perturbSize;
